...
<MermaidWithHtml>
  ...
  <NodeDescriptions>
    <NodeDescription for="1,2,4">
      <strong>Arbitrum Orbit</strong> is a new product offering that lets you
      create your own customizable L2 or L3 chain.
    </NodeDescription>
    <NodeDescription for="3">
      L3 Orbit chains can settle to other L2 chains, such as{" "}
      <strong>Arbitrum One</strong>, which settles to Ethereum.
    </NodeDescription>
