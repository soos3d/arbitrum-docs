...
The above configurations are also available in the [Orbit command line options reference page](../../../launch-orbit-chain/reference/command-line-options.md) and can be set using the command line or using the JSON node configuration below:
