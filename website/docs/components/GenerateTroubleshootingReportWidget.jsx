...
export const GenerateTroubleshootingReportWidget = () => {
  let appendConfigDetailsToOutput = function (output) {
    ...
    output = appendLineToText(
      output,
      "Operating system: " + tabWidget.dataset.selectedOS
    );
    output = appendLineToText(
      output,
      "Network: " + tabWidget.dataset.selectedNetwork
    );
    output = appendLineToText(
      output,
      "Node type: " + tabWidget.dataset.selectedNodeType
    );
    return output;
  };
