...
• **new InboxTools**(`l1Signer`, `l2Network`): [`InboxTools`](InboxTools.mdx)
...
• `Private` `Readonly` **l1Network**: [`L1Network`](../interfaces/L1Network.mdx)
...
• `Private` `Readonly` **l2Network**: [`L2Network`](../interfaces/L2Network.mdx)
