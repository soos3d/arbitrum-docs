...
• **new L1ToL2MessageGasEstimator**(`l2Provider`): [`L1ToL2MessageGasEstimator`](L1ToL2MessageGasEstimator.mdx)
...
[`L1ToL2MessageGasEstimator`](L1ToL2MessageGasEstimator.mdx)
...
▸ **populateFunctionParams**(`dataFunc`, `l1Provider`, `gasOverrides?`): `Promise`\<\{ `data`: `BytesLike` ; `estimates`: `L1ToL2MessageGasParams` ; `retryable`: [`RetryableData`](../interfaces/RetryableData.mdx) ; `to`: `string` ; `value`: `BigNumberish` }\>
...
`Promise`\<\{ `data`: `BytesLike` ; `estimates`: `L1ToL2MessageGasParams` ; `retryable`: [`RetryableData`](../interfaces/RetryableData.mdx) ; `to`: `string` ; `value`: `BigNumberish` }\>
