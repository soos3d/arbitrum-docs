...
• **new L1ToL2MessageReader**(`l2Provider`, `chainId`, `sender`, `messageNumber`, `l1BaseFee`, `messageData`): [`L1ToL2MessageReader`](L1ToL2MessageReader.mdx)
...
[L1ToL2Message](L1ToL2Message.mdx).[constructor](L1ToL2Message.mdx#constructor)
...
[L1ToL2Message](L1ToL2Message.mdx).[chainId](L1ToL2Message.mdx#chainid)
...
[L1ToL2Message](L1ToL2Message.mdx).[l1BaseFee](L1ToL2Message.mdx#l1basefee)
...
[L1ToL2Message](L1ToL2Message.mdx).[messageData](L1ToL2Message.mdx#messagedata)
...
[L1ToL2Message](L1ToL2Message.mdx).[messageNumber](L1ToL2Message.mdx#messagenumber)
...
[L1ToL2Message](L1ToL2Message.mdx).[retryableCreationId](L1ToL2Message.mdx#retryablecreationid)
...
[L1ToL2Message](L1ToL2Message.mdx).[sender](L1ToL2Message.mdx#sender)
...
[L1ToL2Message](L1ToL2Message.mdx).[calculateSubmitRetryableId](L1ToL2Message.mdx#calculatesubmitretryableid)
...
[L1ToL2Message](L1ToL2Message.mdx).[fromEventComponents](L1ToL2Message.mdx#fromeventcomponents)
