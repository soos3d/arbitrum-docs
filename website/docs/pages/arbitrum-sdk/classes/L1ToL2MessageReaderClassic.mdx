...
• **new L1ToL2MessageReaderClassic**(`l2Provider`, `chainId`, `messageNumber`): [`L1ToL2MessageReaderClassic`](L1ToL2MessageReaderClassic.mdx)
...
[`L1ToL2MessageReaderClassic`](L1ToL2MessageReaderClassic.mdx)
