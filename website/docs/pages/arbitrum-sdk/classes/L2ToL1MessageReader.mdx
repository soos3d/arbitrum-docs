...
- [`L2ToL1Message`](L2ToL1Message.mdx)
...
• **new L2ToL1MessageReader**(`l1Provider`, `event`): [`L2ToL1MessageReader`](L2ToL1MessageReader.mdx)
...
[L2ToL1Message](L2ToL1Message.mdx).[constructor](L2ToL1Message.mdx#constructor)
...
[L2ToL1Message](L2ToL1Message.mdx).[isClassic](L2ToL1Message.mdx#isclassic)
...
[L2ToL1Message](L2ToL1Message.mdx).[fromEvent](L2ToL1Message.mdx#fromevent)
...
[L2ToL1Message](L2ToL1Message.mdx).[getL2ToL1Events](L2ToL1Message.mdx#getl2tol1events)
