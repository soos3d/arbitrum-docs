...
• **new MultiCaller**(`provider`, `address`): [`MultiCaller`](MultiCaller.mdx)
...
▸ **fromProvider**(`provider`): `Promise`\<[`MultiCaller`](MultiCaller.mdx)\>
...
`Promise`\<[`MultiCaller`](MultiCaller.mdx)\>
