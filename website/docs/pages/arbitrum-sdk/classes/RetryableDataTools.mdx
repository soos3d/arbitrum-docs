...
• **new RetryableDataTools**(): [`RetryableDataTools`](RetryableDataTools.mdx)

#### Returns

[`RetryableDataTools`](RetryableDataTools.mdx)
...
▸ **tryParseError**(`ethersJsErrorOrData`): `null` \| [`RetryableData`](../interfaces/RetryableData.mdx)
...
`null` \| [`RetryableData`](../interfaces/RetryableData.mdx)
